...
<body>
   ...
   ?>
    <div class="wrapper">
        ...
        <!-- Page Content  -->
        <div id="content">
            <h2 id="animal">Material - Alterar Informações</h2>
            <form  method="POST" action="../../procedimentos/material/alterar.php">
                  <input type="hidden" name="id" value="<?=$id?>" >
              <div class="form-group">
                <label for="exampleInputEmail1">Nome:</label>
                <input type="text" class="form-control" placeholder="Campo de texto"  name="nome" id="nome"
    value="<?=$array['nome']?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="quant_atual" id="quantidade"  value="<?=$array['quantidade_atual']?>">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Quantidade ideal:</label>
                <input type="number" class="form-control" name="quant_ideal" id="quantidade"  value="<?=$array['quantidade_ideal']?>">
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Preço:</label>
                <input type="text" class="form-control" name="preco" id="preco" placeholder="preco" value="<?=$array['preco']?>">
              </div>
